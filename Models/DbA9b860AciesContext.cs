...
public partial class DbA9b860AciesContext : DbContext
{
    public DbA9b860AciesContext()
    {
    }

    public DbA9b860AciesContext(DbContextOptions<DbA9b860AciesContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<DefaultSuspeciousWord> DefaultSuspeciousWords { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_Accounts_Payable_1");
            ...
            entity.HasOne(d => d.AccountNavigation).WithMany(p => p.AccountsPayables)
                .HasForeignKey(d => d.Account)
                .HasConstraintName("FK_Accounts_Payable_Original_Account_Names");
        });

        modelBuilder.Entity<AccountsReceivable>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK_Accounts_Receivable_1");
            ...
            entity.HasOne(d => d.AccountNavigation).WithMany(p => p.AccountsReceivables)
                .HasForeignKey(d => d.Account)
                .HasConstraintName("FK_Accounts_Receivable_Original_Account_Names");
        });
        ...
        modelBuilder.Entity<AnalysisType>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("ID");
            entity.Property(e => e.AnalysisType1)
                .IsRequired()
                .HasMaxLength(50)
        ...
        modelBuilder.Entity<AnlysCpsValue>(entity =>
        {
            ...
            entity.HasOne(d => d.Trans).WithMany(p => p.AnlysCpsValues)
                .HasForeignKey(d => d.Transid)
                .HasConstraintName("FK_anlys_CPs_values_Transactions");
        });
        ...
        modelBuilder.Entity<DefaultSuspeciousWord>(entity =>
        {
        ...
        modelBuilder.Entity<EngagmentTb>(entity =>
        {
            ...
            entity.HasOne(d => d.AnalysisTypeNavigation).WithMany(p => p.EngagmentTbs)
                .HasForeignKey(d => d.AnalysisType)
                .HasConstraintName("FK_EngagmentTB_Analysis_Types");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_General_Ledger_Internal_1");
            ...
            entity.HasOne(d => d.AccountNavigation).WithMany(p => p.GeneralLedgerInternals)
                .HasForeignKey(d => d.Account)
                .HasConstraintName("FK_General_Ledger_Internal_Original_Account_Names");
        });
        ...
        modelBuilder.Entity<Transaction>(entity =>
        {
            ...
            entity.HasOne(d => d.Engagement).WithMany(p => p.Transactions)
                .HasForeignKey(d => d.EngagementId)
