...
namespace AciesManagmentProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DbA9b860AciesContext>(options =>
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "AciesManagmentProject v1"));
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapHub<StoredProcedureHub>("/storedProcedureHub"); 
            });
        }
    }
}
